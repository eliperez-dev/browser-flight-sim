//! Weather window — toggled from the menu bar. Time of day and fog sliders.
...
impl Plugin for WorldMenuPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(EguiPrimaryContextPass, draw_world.in_set(crate::ui::UiSet));
    }
}
...
fn draw_world(
    ...
    egui::Window::new("Weather")
        ...
        .resizable(false)
        .show(ctx, |ui| {
            draw_weather_tab(ui, &mut sky, &mut fog);
        });
